package com.example.wazitoecommerce.ui.theme.screens.tables
            ...
            Row(
                ...
                Card (modifier = Modifier.padding(start = 5.dp)){
                    Column {
                        ...
                        Text(
                            text = "Electric adjustable table",
                            fontSize = 15.sp,
            ...
            Row(
                    ...
                    Column {
                        Card(
                            ...
                            Box(
                                ...
                                Image(
                                    painter = painterResource(id = R.drawable.coff),
                ...
                Card {
                    Column {
                        ...
                        Spacer(modifier = Modifier.height(5.dp))
                        Text(
                            text = "Miami Styled coffie table",
                            fontSize = 20.sp,
                            fontFamily = FontFamily.Serif,
                            fontWeight = FontWeight.Bold,
                        )
                    ...
                    Column {
                        Card(
                            ...
                            Box(
                                ...
                                Image(
                                    painter = painterResource(id = R.drawable.ga),
                    ...
                    Column {
                        Card(
                            ...
                            Box(
                                ...
                                Image(
                                    painter = painterResource(id = R.drawable.za),
